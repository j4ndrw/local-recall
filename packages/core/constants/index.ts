...
export const IMAGE_DESCRIPTION_PROMPT =
  'This is a screenshot of a desktop, describe what you see, what windows or programs are open, and what is the user doing. If there is a web browser open, describe the contents of the web page. Refrain from using the word "screenshot" or "desktop" in your description. Include as much detail as possible and focus in on details. For example "This user is listening to music", or "This user is writing some code"';
